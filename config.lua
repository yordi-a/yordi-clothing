...
menu_options = {
    {name = "Kıyafetler", f = customise, param = nil},
    {name = "Aksesuarlar", f = accessories, param = nil},
    {name = "Yüz", f = overlays, param = nil},
    {name = "Erkek Pedler", f = listModels, param = male_models},
    {name = "Kadın Pedler", f = listModels, param = female_models},
    {name = "Farklı Pedler", f = listModels, param = ems_models},
    {name = "Farklı Pedler 2", f = listModels, param = mp_models},
    {name = "Normal Ped", f = listModels, param = freemode_models},
}
player_data  = {
...
local clothing_shops = {
    {x=1932.76989746094, y=3727.73510742188, z=33.8444557189941},
    {x=1693.26, y=4822.27, z=43.06},
    {x=118.39, y=-232.26, z=55.55},
    {x=-710.16, y=-153.26, z=38.41},
    {x=-821.69, y=-1073.90, z=12.32},
    {x=-1192.81, y=-768.24, z=18.31},
    {x=4.25, y=6512.88, z=32.87},
    {x=425.471, y=-806.164, z=30.4911},
}
incircle = false
    ...
    while true do
        ...
        for k,v in ipairs(clothing_shops) do
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                DrawMarker(20, v.x, v.y, v.z - 1, 0, 0, 0, 0, 0, 0, 0.60, 0.35, 0.35, 255, 0, 0,255, 0, 0.50, 0,0)
                if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 2.0)then
                    if (incircle == false) then
                        DisplayHelpText("~INPUT_CONTEXT~ ile kıyafet menüsünü aç!")
                    end
                    incircle = true
